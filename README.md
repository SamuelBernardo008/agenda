...
Este projeto foi elaborado para permitir o aprendizado de conceitos como o padrão de projeto MVC (Model-View-Controller), framework Flask e seus componentes, variáveis de ambientes, paradigma de programção orientado a objetos e reforço de fundamentos da linguagem de programação Python.
